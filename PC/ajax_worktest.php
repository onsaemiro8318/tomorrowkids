...
<div>
  ...
  <p id="answer1" onmouseover="select_answer(this.id);" onclick="select_answer(this.id);"><a href="javascript:save_info('<?=$answer_data[0][idx]?>');"><?=$answer_data[0][test_value]?></a></p>
  <p id="answer2" onmouseover="select_answer(this.id);" onclick="select_answer(this.id);"><a href="javascript:save_info('<?=$answer_data[1][idx]?>');"><?=$answer_data[1][test_value]?></a></p>
