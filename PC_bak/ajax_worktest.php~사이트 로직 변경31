...
?>
  ...
  <div class="hidden">
    ...
    <div class="fl_left textinbox">
      ...
      <p>
        <div id="answer_al_1" class="fl_left tag">A.</div><span class="anstextone fl_left" id="answer1" onmouseover="select_answer(this.id,'over');" onmouseout="select_answer(this.id,'out')" onclick="go_next_question('<?=$answer_data[0]['idx']?>','<?=$next_num?>','<?=$_POST['selected_val']?>')" style="cursor:pointer;padding-bottom:20px"><?=$answer_data[0]['test_value']?></span></p>
      <p><div id="answer_al_2" class="fl_left tag">B.</div><span class="anstextone fl_left" id="answer2" onmouseover="select_answer(this.id,'over');" onmouseout="select_answer(this.id,'out')" onclick="go_next_question('<?=$answer_data[1]['idx']?>','<?=$next_num?>','<?=$_POST['selected_val']?>')" style="cursor:pointer;"><?=$answer_data[1]['test_value']?></span></p>
    </div>
  </div>
<?
    //if($next_num == 11){
