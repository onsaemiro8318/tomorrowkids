...
?>
        ...
        <div class="kakaostory_dt_button"><a href="#" onclick="ks_share_mobile('<?=$user_job[job]?>','<?=$user_job[job_explain]?>','<?=$test_idx?>','<?=$job_imgurl2?>');"><img src="images/kakaostory_mobbut_1.png"/></a></div>
<?
	}
?>    
    </div>
