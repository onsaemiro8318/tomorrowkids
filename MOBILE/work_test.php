...
상상 이상의 특별한 일들이 기다리고 있답니다!
    ...
    <div class="top2_content" id="test_div">
      ...
      <div id="answer_al_1" class="ansbox" onclick="javascript:go_next_question_mobile('<?=$answer_data[0]["idx"]?>','<?=$next_num?>','')">
        <div class="fl_left tag">A.</div>
        <div class="fl_left tagtext2" id="answer1" ><?=$answer_data[0]['test_value']?></div>
      </div>
      <div id="answer_al_2" class="ansbox" onclick="javascript:go_next_question_mobile('<?=$answer_data[1]["idx"]?>','<?=$next_num?>','')">
