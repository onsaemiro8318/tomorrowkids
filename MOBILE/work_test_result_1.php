...
<html>
  <head>
    ...
    <meta property="og:url" content="http://www.tomorrowkids.or.kr/MOBILE/work_test_result_1.php" />
    <meta property="og:image" content="http://www.tomorrowkids.or.kr/images/fb/jobbigimg_1.jpg" />
...
아이들의 내일(Tomorrow)을 위한 기부로 이어집니다.
        ...
        <div class="kakaostory_dt_button"><a href="#" onclick="ks_share_mobile('<?=$user_job['job']?>','<?=$user_job['job_explain']?>','<?=$test_idx?>','<?=$job_imgurl_kakao?>');"><img src="images/kakaostory_mobbut_1.png"/></a>
          <p style="padding:10px 0px 0px 20px;">* 페이스북앱에서는 카스 공유가 되지 않습니다.</p></div>
    </div>
